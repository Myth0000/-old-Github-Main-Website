...
export default class Projects extends React.Component {
  ...
  projectClicked(name, imageUrl, description, socialMediaArray, imagesArray) {
    ...
    let socialMediaContainer = getElement(
      ".ProjectOverview .ProjectSocialMediaContainer"
    );
    ...
    for (let [index, socialMedia] of socialMediaArray.entries()) {
      ...
      getElement(
        ".ProjectOverview .ProjectSocialMediaContainer .SocialMedia",
        index
      ).appendChild(socialMediaImage);
      ...
      getElement(
        ".ProjectOverview .ProjectSocialMediaContainer .SocialMedia",
        index
      ).appendChild(socialMediaContent);
    }
  }
